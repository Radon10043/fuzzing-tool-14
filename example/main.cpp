...
int main(int argc, char *argv[])
{
	...
	while (1)
	{
		...
		if (n > 0)
		{
			//int testArr[8] = { 1000, 2, 204, 30, 50, 1, 50, 1 };
			//sendUDPresult(testArr, sizeof(testArr) / sizeof(testArr[0]));
			dtg = (Datagram*)buf;
			CheckData((Datagram *)buf);//入口,CheckData.cpp 96行
		}
		else
		{
			break;
